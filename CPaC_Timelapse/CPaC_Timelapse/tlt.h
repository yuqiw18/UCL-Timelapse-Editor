...
namespace TLT {
	...
	std::vector<cv::Mat> RetimeSequence(std::vector<cv::Mat> raw_sequence, std::vector<cv::Mat> optical_flow, std::vector<cv::Mat> remap_xy, int interval);
	...
	std::vector<cv::Mat> ComputeOpticalFlow2(std::vector<cv::Mat> raw_sequence);
	std::vector<cv::Mat> RetimeSequence2(std::vector<cv::Mat> raw_sequence, std::vector<cv::Mat> optical_flow, std::vector<cv::Mat> remap_xy, int interval);
}
